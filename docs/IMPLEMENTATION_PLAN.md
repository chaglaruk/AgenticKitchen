...
Therefore the **targeted physical-acceptance gate is closed for source-behavior SHA `b5f751b4909299eef33dd575bbfbf6e30a26de8a`**. Any later documentation-only commit does not change that binary/source behaviour and must be described as such rather than falsely claiming a new APK was physically tested.
